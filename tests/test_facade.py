...
MENTION = {
    ...
    "post": {"platform": "reddit", "url": "https://r/1", "text": "hi", "publishedAt": "2026-09-03T08:12:44.000Z", "replyTo": None},
    "author": None,
    "classification": None,
...
def test_bodies_take_fields_a_dict_or_a_model():
    ...
    def handler(request: httpx.Request) -> httpx.Response:
        ...
        return json_response(201, {"id": "kw_1", "term": "acme", "kind": "brand", "muted": False, "pausedForBalance": False, "platforms": None, "stats": {"mentions": 0, "relevant": 0, "last7d": 0, "lastMentionAt": None}, "polling": [], "createdAt": "2026-09-03T10:04:44.881Z"})
