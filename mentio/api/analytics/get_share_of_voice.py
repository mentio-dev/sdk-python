...
def sync_detailed(
    *,
    ...
    """Brand against competitors
     ...
     Every keyword matched in the window with its counts and its share of brand plus competitor matches;
    topic keywords are counted but stay out of the split. The window is `range` (7d, 30d, 90d, 365d,
    ...
    Args:
        range_ (GetShareOfVoiceRange | Unset): Preset window ending today. Ignored when from or to
            is given. Default 30d.
        ...
        platforms (list[GetShareOfVoicePlatformsItem] | Unset): Only these platforms. Repeatable,
