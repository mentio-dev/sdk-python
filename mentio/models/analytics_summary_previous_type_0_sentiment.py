...
T = TypeVar("T", bound="AnalyticsSummaryPreviousType0Sentiment")


@_attrs_define
class AnalyticsSummaryPreviousType0Sentiment:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        analytics_summary_previous_type_0_sentiment = cls(
            positive=positive,
            neutral=neutral,
            negative=negative,
            unclassified=unclassified,
        ...
        analytics_summary_previous_type_0_sentiment.additional_properties = d
        return analytics_summary_previous_type_0_sentiment
