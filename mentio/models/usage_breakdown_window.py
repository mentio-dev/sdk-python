...
class UsageBreakdownWindow:
    ...
    Attributes:
        from_ (str): First day, YYYY-MM-DD, inclusive, UTC.
        to (str): Last day, inclusive: today for a trailing window or the running month.
        days (int): Length of the window in days.
        keyword_days_from (None | str): The first day of the window with a recorded keyword count, or null when there is
            none. Earlier days carry keywordDays: null.
    """
