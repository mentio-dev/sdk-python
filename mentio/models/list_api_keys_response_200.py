...
if TYPE_CHECKING:
    from ..models.list_api_keys_response_200_data_item import (
...
class ListApiKeysResponse200:
    """
    Attributes:
        data (list[ListApiKeysResponse200DataItem]):
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for data_item_data in _data:
            data_item = ListApiKeysResponse200DataItem.from_dict(data_item_data)
