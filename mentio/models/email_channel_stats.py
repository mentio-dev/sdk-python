...
if TYPE_CHECKING:
    from ..models.email_channel_stats_last_7d import EmailChannelStatsLast7D


T = TypeVar("T", bound="EmailChannelStats")


@_attrs_define
class EmailChannelStats:
    ...
    Attributes:
        ...
        last7d (EmailChannelStatsLast7D): Deliveries in the last 7 days.
    """

    alerts: int
    active_alerts: int
    last_delivery_at: None | str
    last7d: EmailChannelStatsLast7D
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.email_channel_stats_last_7d import (
        ...
        last7d = EmailChannelStatsLast7D.from_dict(d.pop("last7d"))

        email_channel_stats = cls(
            alerts=alerts,
        ...
        email_channel_stats.additional_properties = d
        return email_channel_stats
