...
T = TypeVar("T", bound="ListKeywordsResponse200DataItemStatsCost")


@_attrs_define
class ListKeywordsResponse200DataItemStatsCost:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        list_keywords_response_200_data_item_stats_cost.additional_properties = d
        return list_keywords_response_200_data_item_stats_cost
