...
T = TypeVar("T", bound="AnalyticsSummaryReach")


@_attrs_define
class AnalyticsSummaryReach:
    """Estimated reach.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        analytics_summary_reach = cls(
            followers=followers,
            people=people,
        )

        analytics_summary_reach.additional_properties = d
        return analytics_summary_reach
