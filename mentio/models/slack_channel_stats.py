...
if TYPE_CHECKING:
    from ..models.slack_channel_stats_last_7d import SlackChannelStatsLast7D


T = TypeVar("T", bound="SlackChannelStats")


@_attrs_define
class SlackChannelStats:
    ...
    Attributes:
        ...
        last7d (SlackChannelStatsLast7D): Deliveries in the last 7 days.
    """

    alerts: int
    active_alerts: int
    last_delivery_at: None | str
    last7d: SlackChannelStatsLast7D
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.slack_channel_stats_last_7d import (
        ...
        last7d = SlackChannelStatsLast7D.from_dict(d.pop("last7d"))

        slack_channel_stats = cls(
            alerts=alerts,
        ...
        slack_channel_stats.additional_properties = d
        return slack_channel_stats
