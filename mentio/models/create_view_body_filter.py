...
from ..models.create_view_body_filter_keyword_kinds_item import (
    CreateViewBodyFilterKeywordKindsItem,
)
from ..models.create_view_body_filter_not_platforms_item import (
    CreateViewBodyFilterNotPlatformsItem,
)
from ..models.create_view_body_filter_not_sentiments_item import (
    CreateViewBodyFilterNotSentimentsItem,
)
from ..models.create_view_body_filter_platforms_item import (
    CreateViewBodyFilterPlatformsItem,
)
from ..models.create_view_body_filter_sentiments_item import (
...
class CreateViewBodyFilter:
    ...
    Attributes:
        ...
        sentiments (list[CreateViewBodyFilterSentimentsItem] | Unset): Only these sentiments.
        not_sentiments (list[CreateViewBodyFilterNotSentimentsItem] | Unset): Never these sentiments; an unscored
    ...
    sentiments: list[CreateViewBodyFilterSentimentsItem] | Unset = UNSET
    not_sentiments: list[CreateViewBodyFilterNotSentimentsItem] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _keyword_kinds is not UNSET:
            ...
            for keyword_kinds_item_data in _keyword_kinds:
                keyword_kinds_item = CreateViewBodyFilterKeywordKindsItem(
        ...
        if _platforms is not UNSET:
            ...
            for platforms_item_data in _platforms:
                platforms_item = CreateViewBodyFilterPlatformsItem(platforms_item_data)
        ...
        if _not_platforms is not UNSET:
            ...
            for not_platforms_item_data in _not_platforms:
                not_platforms_item = CreateViewBodyFilterNotPlatformsItem(
        ...
        status: CreateViewBodyFilterStatus | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = CreateViewBodyFilterStatus(_status)
        ...
        if _sentiments is not UNSET:
            ...
            for sentiments_item_data in _sentiments:
                sentiments_item = CreateViewBodyFilterSentimentsItem(
        ...
        if _not_sentiments is not UNSET:
            ...
            for not_sentiments_item_data in _not_sentiments:
                not_sentiments_item = CreateViewBodyFilterNotSentimentsItem(
        ...
        return create_view_body_filter
