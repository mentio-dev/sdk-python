...
T = TypeVar("T", bound="WhoamiUserType0")


@_attrs_define
class WhoamiUserType0:
    """The person behind an OAuth token or a session; null for an API key, which has no person behind it.

    Attributes:
        id (str): User id, what assigneeId and ownerId take.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        whoami_user_type_0 = cls(
            id=id,
            email=email,
            name=name,
        )

        whoami_user_type_0.additional_properties = d
        return whoami_user_type_0
