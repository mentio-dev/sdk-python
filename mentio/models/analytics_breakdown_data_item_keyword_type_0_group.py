...
T = TypeVar("T", bound="AnalyticsBreakdownDataItemKeywordType0Group")


@_attrs_define
class AnalyticsBreakdownDataItemKeywordType0Group:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        analytics_breakdown_data_item_keyword_type_0_group = cls(
            id=id,
            name=name,
        ...
        analytics_breakdown_data_item_keyword_type_0_group.additional_properties = d
        return analytics_breakdown_data_item_keyword_type_0_group
