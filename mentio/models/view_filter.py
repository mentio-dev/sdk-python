...
from ..models.view_filter_sentiments_item import ViewFilterSentimentsItem
from ..models.view_filter_status import ViewFilterStatus
...
class ViewFilter:
    ...
    Attributes:
        ...
        keyword_kinds (list[ViewFilterKeywordKindsItem] | Unset): Only matches of keywords of any of these kinds: brand,
            competitor, topic.
        platforms (list[ViewFilterPlatformsItem] | Unset): Only posts from any of these platforms.
        not_platforms (list[ViewFilterNotPlatformsItem] | Unset): Never posts from these platforms.
        status (ViewFilterStatus | Unset): Only mentions in this status: open, ignored, done.
        ...
        sentiments (list[ViewFilterSentimentsItem] | Unset): Only these sentiments.
        not_sentiments (list[ViewFilterNotSentimentsItem] | Unset): Never these sentiments; an unscored mention still
            passes.
    ...
    keyword_kinds: list[ViewFilterKeywordKindsItem] | Unset = UNSET
    platforms: list[ViewFilterPlatformsItem] | Unset = UNSET
    not_platforms: list[ViewFilterNotPlatformsItem] | Unset = UNSET
    status: ViewFilterStatus | Unset = UNSET
    relevant: bool | Unset = UNSET
    min_relevance: int | Unset = UNSET
    min_confidence: float | Unset = UNSET
    sentiments: list[ViewFilterSentimentsItem] | Unset = UNSET
    not_sentiments: list[ViewFilterNotSentimentsItem] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _keyword_kinds is not UNSET:
            ...
            for keyword_kinds_item_data in _keyword_kinds:
                keyword_kinds_item = ViewFilterKeywordKindsItem(keyword_kinds_item_data)
        ...
        if _platforms is not UNSET:
            ...
            for platforms_item_data in _platforms:
                platforms_item = ViewFilterPlatformsItem(platforms_item_data)
        ...
        if _not_platforms is not UNSET:
            ...
            for not_platforms_item_data in _not_platforms:
                not_platforms_item = ViewFilterNotPlatformsItem(not_platforms_item_data)

                not_platforms.append(not_platforms_item)

        _status = d.pop("status", UNSET)
        status: ViewFilterStatus | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = ViewFilterStatus(_status)
        ...
        if _sentiments is not UNSET:
            ...
            for sentiments_item_data in _sentiments:
                sentiments_item = ViewFilterSentimentsItem(sentiments_item_data)
        ...
        if _not_sentiments is not UNSET:
            ...
            for not_sentiments_item_data in _not_sentiments:
                not_sentiments_item = ViewFilterNotSentimentsItem(
