...
if TYPE_CHECKING:
    from ..models.telegram_channel_stats_last_7d import TelegramChannelStatsLast7D


T = TypeVar("T", bound="TelegramChannelStats")
...
class TelegramChannelStats:
    ...
    Attributes:
        ...
        last7d (TelegramChannelStatsLast7D): Deliveries in the last 7 days.
    """

    alerts: int
    active_alerts: int
    last_delivery_at: None | str
    last7d: TelegramChannelStatsLast7D
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.telegram_channel_stats_last_7d import (
        ...
        last7d = TelegramChannelStatsLast7D.from_dict(d.pop("last7d"))

        telegram_channel_stats = cls(
            alerts=alerts,
        ...
        telegram_channel_stats.additional_properties = d
