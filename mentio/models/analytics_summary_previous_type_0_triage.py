...
T = TypeVar("T", bound="AnalyticsSummaryPreviousType0Triage")


@_attrs_define
class AnalyticsSummaryPreviousType0Triage:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        analytics_summary_previous_type_0_triage = cls(
            open_=open_,
            ignored=ignored,
            done=done,
            waiting=waiting,
        ...
        analytics_summary_previous_type_0_triage.additional_properties = d
        return analytics_summary_previous_type_0_triage
