...
from ..models.list_people_response_200_data_item_accounts_item_platform import (
    ListPeopleResponse200DataItemAccountsItemPlatform,
)

T = TypeVar("T", bound="ListPeopleResponse200DataItemAccountsItem")


@_attrs_define
class ListPeopleResponse200DataItemAccountsItem:
    """
    Attributes:
    ...
    id: str
    platform: ListPeopleResponse200DataItemAccountsItemPlatform
    name: None | str
    handle: None | str
    url: None | str
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        platform = ListPeopleResponse200DataItemAccountsItemPlatform(d.pop("platform"))
        ...
        list_people_response_200_data_item_accounts_item = cls(
            id=id,
            platform=platform,
            name=name,
            handle=handle,
        ...
        list_people_response_200_data_item_accounts_item.additional_properties = d
        return list_people_response_200_data_item_accounts_item
