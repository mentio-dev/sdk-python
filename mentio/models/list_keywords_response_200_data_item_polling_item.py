...
from ..models.list_keywords_response_200_data_item_polling_item_platform import (
    ListKeywordsResponse200DataItemPollingItemPlatform,
)

T = TypeVar("T", bound="ListKeywordsResponse200DataItemPollingItem")


@_attrs_define
class ListKeywordsResponse200DataItemPollingItem:
    """
    Attributes:
    ...
    platform: ListKeywordsResponse200DataItemPollingItemPlatform
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        d = dict(src_dict)
        platform = ListKeywordsResponse200DataItemPollingItemPlatform(d.pop("platform"))
        ...
        list_keywords_response_200_data_item_polling_item = cls(
            platform=platform,
            last_polled_at=last_polled_at,
            empty_polls=empty_polls,
        )

        list_keywords_response_200_data_item_polling_item.additional_properties = d
        return list_keywords_response_200_data_item_polling_item
