...
if TYPE_CHECKING:
    from ..models.list_alerts_response_200_data_item import (
...
class ListAlertsResponse200:
    """
    Attributes:
        data (list[ListAlertsResponse200DataItem]):
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for data_item_data in _data:
            data_item = ListAlertsResponse200DataItem.from_dict(data_item_data)
