...
from ..models.update_keyword_body_matching_required_mode import (
    UpdateKeywordBodyMatchingRequiredMode,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateKeywordBodyMatching")


@_attrs_define
class UpdateKeywordBodyMatching:
    ...
    Attributes:
        ...
        required_mode (UpdateKeywordBodyMatchingRequiredMode | Unset): any: at least one required term must appear. all:
            every one must.
    ...
    required_mode: UpdateKeywordBodyMatchingRequiredMode | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        required_mode: UpdateKeywordBodyMatchingRequiredMode | Unset
        if isinstance(_required_mode, Unset):
            required_mode = UNSET
        else:
            required_mode = UpdateKeywordBodyMatchingRequiredMode(_required_mode)
        ...
        update_keyword_body_matching = cls(
        ...
        update_keyword_body_matching.additional_properties = d
        return update_keyword_body_matching
