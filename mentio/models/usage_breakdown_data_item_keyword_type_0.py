...
class UsageBreakdownDataItemKeywordType0:
    ...
    Attributes:
        id (str): Keyword id (kw_...); a deleted keyword keeps its id here.
        term (str): The term as it was last metered, or as the keyword reads now.
        removed (bool): The keyword has since been deleted. Its charges stay on the record; its mentions went with it,
            so its mention counts read 0.
    """
