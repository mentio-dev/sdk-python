...
from ..models.update_segment_body_filter_keyword_kinds_item import (
    UpdateSegmentBodyFilterKeywordKindsItem,
)
from ..models.update_segment_body_filter_never_keyword_kinds_item import (
    UpdateSegmentBodyFilterNeverKeywordKindsItem,
)
from ..models.update_segment_body_filter_not_platforms_item import (
    UpdateSegmentBodyFilterNotPlatformsItem,
)
from ..models.update_segment_body_filter_platforms_item import (
    UpdateSegmentBodyFilterPlatformsItem,
)
from ..models.update_segment_body_filter_stages_item import (
    UpdateSegmentBodyFilterStagesItem,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateSegmentBodyFilter")


@_attrs_define
class UpdateSegmentBodyFilter:
    """Replaces the whole filter.

    Attributes:
        platforms (list[UpdateSegmentBodyFilterPlatformsItem] | Unset): People with an account on any of these
            platforms.
        ...
        keyword_kinds (list[UpdateSegmentBodyFilterKeywordKindsItem] | Unset): Mentioned a keyword of any of these
            kinds.
        never_keyword_kinds (list[UpdateSegmentBodyFilterNeverKeywordKindsItem] | Unset): Never mentioned a keyword of
            these kinds.
        not_platforms (list[UpdateSegmentBodyFilterNotPlatformsItem] | Unset): Nobody with an account on these
            platforms.
        ...
        stages (list[UpdateSegmentBodyFilterStagesItem] | Unset): People at any of these outreach stages.
    ...
    platforms: list[UpdateSegmentBodyFilterPlatformsItem] | Unset = UNSET
    ...
    keyword_kinds: list[UpdateSegmentBodyFilterKeywordKindsItem] | Unset = UNSET
    never_keyword_kinds: list[UpdateSegmentBodyFilterNeverKeywordKindsItem] | Unset = (
        UNSET
    )
    not_platforms: list[UpdateSegmentBodyFilterNotPlatformsItem] | Unset = UNSET
    ...
    stages: list[UpdateSegmentBodyFilterStagesItem] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _platforms is not UNSET:
            ...
            for platforms_item_data in _platforms:
                platforms_item = UpdateSegmentBodyFilterPlatformsItem(
                    platforms_item_data
                )
        ...
        if _keyword_kinds is not UNSET:
            ...
            for keyword_kinds_item_data in _keyword_kinds:
                keyword_kinds_item = UpdateSegmentBodyFilterKeywordKindsItem(
        ...
        never_keyword_kinds: (
            list[UpdateSegmentBodyFilterNeverKeywordKindsItem] | Unset
        ) = UNSET
        if _never_keyword_kinds is not UNSET:
            never_keyword_kinds = []
            for never_keyword_kinds_item_data in _never_keyword_kinds:
                never_keyword_kinds_item = UpdateSegmentBodyFilterNeverKeywordKindsItem(
        ...
        if _not_platforms is not UNSET:
            ...
            for not_platforms_item_data in _not_platforms:
                not_platforms_item = UpdateSegmentBodyFilterNotPlatformsItem(
        ...
        if _stages is not UNSET:
            ...
            for stages_item_data in _stages:
                stages_item = UpdateSegmentBodyFilterStagesItem(stages_item_data)
        ...
        update_segment_body_filter.additional_properties = d
        return update_segment_body_filter
